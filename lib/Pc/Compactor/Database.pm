...
B<Pc::Compactor::Database> - a database level processing for bloat
reducing.

=head1 SYNOPSIS

	my $database_compactor = Pc::Compactor::Database->new(
		database => $database,
		logger => $logger,
...
B<Pc::Compactor::Database> class is an implementation of a database
